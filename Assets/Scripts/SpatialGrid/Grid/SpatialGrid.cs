...
public class SpatialGrid : MonoBehaviour {
    ...
    public void AddNewGridEntity(IGridEntity entity)
    {
        entity.OnMove += UpdateEntity;
        UpdateEntity(entity);
    }

    public void RemoveGridEntity(IGridEntity entity)
    {
        entity.OnMove -= UpdateEntity;
        UpdateEntity(entity);
    }
        ...
        return cells
              ...
              .Where(e =>
                         ...
                         from.y <= e.Position.y && e.Position.y <= to.y
                            //from.y <= e.Position.z && e.Position.z <= to.z
                    )
              .Where(n => filterByPosition(n.Position)/* && !n.GetGO().activeInHierarchy*/);
    }
